...
uploaded_files = st.file_uploader("Choose Images", accept_multiple_files=True, type=["png", "jpeg", "jpg", "heif", "svg", "bmp", "tiff", "jfif", "webp"])
...
if st.button("Generate PDF") and uploaded_files:
    ...
    if compress_option:
        for image in uploaded_files:
            compressed_img = compress_image(image, target_ratio=compression_ratio / 100, quality=compression_quality)
